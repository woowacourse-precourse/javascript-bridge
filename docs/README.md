...
13. [x] - 나는 Admin으로서 UI와 도메인 로직의 구분을 위해 BridgeGame클래스에 InputView, 혹은 OutputView를 사용하지 않고 싶다.
...
4. [x] - 나는 Admin으로서 원활한 게임 진행을 위해 사용자가 다리의 길이로 3이상 20이하의 숫자값만 입력하기를 원한다.
