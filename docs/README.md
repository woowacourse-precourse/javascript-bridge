...
- [ ] 사용자가 입력한 문자가 U 인지 D 인지 확인한다.
  - [ ] 사용자가 입력한 문자가 U일 경우 O 또는 X 표시된 윗다리를 출력한다.
  - [ ] 사용자가 입력한 문자가 D일 경우 O 또는 X 표시된 아래 다리를 출력한다.
- [ ] 사용자가 입력한 문자가 다리의 문자와 같은지 확인한다.
- [ ] 사용자가 입력한 문자와 다리의 문자가 같다면 O, 같지 않다면 X 표시한다.
- [ ] 선택되지 않은 다리는 공백 한 칸으로 표시한다.
