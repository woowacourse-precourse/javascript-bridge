	...
	- [x] 다리 생성 기능
     ...
     - [x] 분류된 다리 로그 가져오는 메서드
         ...
         - [x] 예외사항
           - [x] 사용자 위치가 출발하기 전이라면 예외를 발생한다.
     - [ ] 게임 오버 파악하는 메서드
         - [ ] 현재 플레이어가 게임 오버 상태인지 파악한다.
           - [ ] 예외사항
             - [ ] 사용자 위치가 출발하기 전이라면 예외를 발생한다.
     - [x] App 메서드
       - [x] 게임 시작 안내 문구 메서드
       - [x] 게임 최종 결과 안내 문구 메서드
       - [x] 게임 최종 결과 안내 문구 & 종료 메서드
       - [x] 현재 다리 결과 안내 문구 메서드
       - [x] 로그 기록 메서드
       - [x] 다리 길이 가져오는 메서드
       - [x] 게임 오버 확인 메서드
       - [x] 게임 성공 확인 메서드
       ...
       - [x] 게임 오버 확인 여부 메서드
       - [x] 재시도 메서드
       - [x] 재시도 & 시작 입력 안내 문구 메서드
       - [x] 재시작 입력 검증 메서드
       - [x] 이동 입력 안내 문구 메서드
       - [x] 다리 생성 입력 안내 문구 메서드
       - [x] 재시작 입력 안내 문구 메서드
       - [x] 게임 인스턴스 종료 메서드
       - [x] 게임 플레이 메서드
...
3.  UI 로직
     ...
     - [x] 사용자로부터 입력을 받는 메서드
       ...
       - [x] 사용자가 게임을 다시 시도할지 종료할지 여부를 입력받는다.
           - [x] 예외사항
               - [x] 입력이 없으면 예외를 발생시킨다.
       - [x] 입출력을 제어하기 위해 사용하는 인스턴스를 안전하게 종료하는 메서드
