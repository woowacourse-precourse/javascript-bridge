...
- [x] 기본적으로, 주어진 요구사항에 맞게 사용자 입력을 받고 출력한다.
  ...
  - 잘못된 입력이 들어올 경우 `throw`문을 사용하여 예외를 발생, 에러 메시지를 출력 후 해당 부분부터 다시 입력을 받아야 한다.
...
- [x] 각 메서드 대해 유닛 테스트 코드를 작성하고 예외 처리에 대한 코드를 추가한다.
  - 테스트가 어렵다면 그 즉시 클래스를 추출하는 등의 리팩토링을 진행한다.
- [x] 클래스, 객체를 추가하거나 가독성을 올리기 위한 리팩토링을 진행한다.
