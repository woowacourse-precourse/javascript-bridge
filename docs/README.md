...
- [x] 다리를 건너기를 실패할 경우 게임을 다시 시도할지 여부를 선택하는 문구를 출력하고 R이나 Q를 입력받는 기능.
  - [x] R과 Q를 입력받는 기능
  - [x] 다시 시도할 경우 지금까지 이동한 map 초기화 시키기.
  - [x] 시행한 횟수를 증가시키기
- [x] 종료하거나 다리 건너기를 성공했을 때 `최종 게임 결과`, `게임 성공 여부`, `총 시도한 횟수`를 출력하는 기능.
- [x] 다시 다리 건너기를 재시작할 경우 기존에 랜덤으로 생성한 다리 정보를 기반으로 게임을 재시작하는 기능.
