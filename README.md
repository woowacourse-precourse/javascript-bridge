...
-   시작 시 메시지 출력 : App
-   사용자로부터 길이 입력 받기 : BridgeMaker
    -   입력 예외사항 처리 : InputView
    -   입력받은 길이에 맞게 다리 생성 : BridgeRandomNumberGenerator
    -   결과값 반환 : BridgeMaker -> App
-   게임 시작 : BridgeGame
    -   사용자로 부터 이동 입력 받기 : BridgeGame
        -   입력 예외사항 처리 : InputView
    -   결과처리 : BridgeGame
        -   다리 출력: OutputView
    -   오답 시 재시도 여부 처리 : BridgeGame
        -   입력 예외사항 처리 : InputView
    -   성공 여부 및 횟수 출력: OutputView
