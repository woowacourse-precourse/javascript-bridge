...
class BridgeGameController {
    ...
    /**
     * 사용자가 입력한 값에 따라 재시작 혹은 종료를 실행하는 함수
     * @param {BridgeGame} bridgeGame 현재 실행 중인 다리 건너기 게임
    ...
    /**
     * 사용자가 재시작 혹은 종료 값을 입력했을 때 값에 따라 실행할 함수들을 저장하고 있는 객체
     */
    restartType = {
        /**
         * 게임을 종료하는 함수
