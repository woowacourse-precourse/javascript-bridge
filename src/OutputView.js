...
const OutputView = {
   ...
   */
  printMap(up, down) {
    Console.print(`${MOVING.START_BRIDGE}${MOVING.BLANK}${up}${MOVING.BLANK}${MOVING.END_BRIDGE}`);
    Console.print(`${MOVING.START_BRIDGE}${MOVING.BLANK}${down}${MOVING.BLANK}${MOVING.END_BRIDGE}`);
  },
