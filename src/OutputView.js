...
const OutputView = {
  ...
  printResult(bridgeGame) {
    ...
    printMap(bridgeGame.getBridge(), bridgeGame.getPath());

    MissionUtils.Console.print('게임 성공 여부: ' + OutputView.RESULT_TEXT[bridgeGame.checkResult()]);
    MissionUtils.Console.print('총 시도한 횟수: ' + bridgeGame.getTryNum());
  },
};
