...
const ERROR = {
  ...
  notRangeOfBridgeLength: '[ERROR] 다리 길이는 3부터 20 사이의 숫자여야 합니다.\n',
  notValidDirectionInput: '[ERROR] 이동할 칸은 위: U, 아래: D 만 입력 가능합니다.\n',
  notValidRetryInput: '[ERROR] 재시도: R, 종료: Q 만 입력 가능합니다.\n',
};
