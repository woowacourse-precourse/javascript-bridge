const CONSTANT = {
  ...
  CHECK: {
    ...
    BRIDGE_LENGTH: size => size < 3 || size > 20 || !Number.isInteger(size),
    DIRECTION: direction => direction !== CONSTANT.DIRECTION.UP && direction !== CONSTANT.DIRECTION.DOWN,
    RESTART: input => input !== CONSTANT.RESTART.RESTART && input !== CONSTANT.RESTART.QUIT,
  },
  ...
  ERROR_MESSAGE: {
    DIRECTION: '[ERROR] 위 아래 방향은 U와 D로 입력하세요',
    BRIDGE_SIZE: '[ERROR] 다리 길이는 3 ~ 20 사이의 정수여야 합니다.',
    RESTART_INPUT: '[ERROR] 재시작 값은 R과 Q로 입력하세요',
  },
