...
const MESSAGE = {
  PROCESS: {
    ...
    ENTER_BRIDGE_LENGTH: `다리의 길이를 입력해주세요.${NEW_LINE}`,
    SELECT_UP_DOWN: `이동할 칸을 선택해주세요. (위: ${BRIDGE_INFO.SELECT_UP}, 아래: ${BRIDGE_INFO.SELECT_DOWN})${NEW_LINE}`,
    SELECT_RESTART_OR_QUIT: `게임을 다시 시도할지 여부를 입력해주세요. (재시도: ${GAME_STATUS.GAME_RESTART}, 종료: ${GAME_STATUS.GAME_QUIT})${NEW_LINE}`,
