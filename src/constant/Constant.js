...
const ERROR_MESSAGE = Object.freeze({
  ...
  IS_RETRY_WORDS: `[ERROR] 올바른 커맨드 재시도:${BRIDGE_DETAIL.RETRY_COMMAND}, 종료:${BRIDGE_DETAIL.END_COMMAND}를 입력해주세요.`,
  IS_NATURAL_NUMBER: "[ERROR] 자연수로 입력해주세요!",
});
...
const ANNOUNCEMENT_MESSAGE = Object.freeze({
  ...
  RETRY: `게임을 다시 시도할지 여부를 입력해주세요. (재시도: ${BRIDGE_DETAIL.RETRY_COMMAND}, 종료:${BRIDGE_DETAIL.END_COMMAND})`,
